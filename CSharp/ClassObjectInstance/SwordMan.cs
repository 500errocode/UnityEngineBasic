...
namespace ClassObjectInstance
{
    ...
    internal class SwordMan
    {
        ...
        // snake_case
        // UPPER_SNAKE_CASE
        // m_hungarian , fValue ( 일반적으로 사용 X ) 

        //접근 제한자
        //public : 접근 제한 없음
        //protected : 자식(상속 타입) 이 부모(기반 타입) 에 접근할 수 있음
        //internal : 동일 어셈블리(프로젝트)에서 제한없이 접근가능
        //private : 더 클래스 접근 불가능
        //클래스는 기본적으로 캡슐화를 위한 타입이기 때문에
        //접근제한자가 명시되지 않을경우에 default 접근제한자는 private임. 
        ...
        //해당 객체가 더이상 참조되지 않을때 .Net 의 CLR 의 GarbageCollector 가
