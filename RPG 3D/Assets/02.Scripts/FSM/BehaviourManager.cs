...
public class BehaviourManager : MonoBehaviour
{
    ...
    public bool ChangeStateForcely(StateID newStateID)
    {
        if (currentStateID == newStateID)
            return false;
    ...
    private void Awake()
    {
        ...
        ComboStackingStateBehaviour[] comboStackingStateBehaviours =
            _currentAnimator.GetBehaviours<ComboStackingStateBehaviour>();
    ...
    private void FixedUpdate()
    {
        ...
        else
        {
            ...
            Vector3.Lerp(_inertia, Vector3.zero, _drag * Time.fixedDeltaTime);
        }
