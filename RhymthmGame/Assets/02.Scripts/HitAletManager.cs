...
{
    public class HitAletManager : MonoBehaviour
    {
        ...
        public void PopUp(HitJudge judge)
        {
            ...
            if (_great.gameObject.activeSelf) _cool.transform.Translate(Vector3.forward);
            if (_good.gameObject.activeSelf) _cool.transform.Translate(Vector3.forward);
            if (_miss.gameObject.activeSelf) _cool.transform.Translate(Vector3.forward);
            if (_bad.gameObject.activeSelf) _cool.transform.Translate(Vector3.forward);
